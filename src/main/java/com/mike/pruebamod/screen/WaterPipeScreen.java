...
import com.mike.pruebamod.screen.renderer.FluidTankRenderer;
import com.mike.pruebamod.util.MouseUtil;
...
public class WaterPipeScreen extends AbstractContainerScreen<WaterPipeMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(PruebaMod.MOD_ID, "textures/gui/water_pipe_gui.png");
